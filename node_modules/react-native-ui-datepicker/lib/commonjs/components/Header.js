...
const Header = ({
  ...
  const renderPrevButton = /*#__PURE__*/_react.default.createElement(_reactNative.Pressable, {
    disabled: calendarView === _enums.CalendarViews.time,
    onPress: () => calendarView === _enums.CalendarViews.day ? onChangeMonth(-1) : calendarView === _enums.CalendarViews.month ? onChangeYear(currentYear - 1) : calendarView === _enums.CalendarViews.year && onChangeYear(currentYear - _utils.YEAR_PAGE_SIZE),
    testID: "btn-prev",
  ...
  const yearSelector = (0, _react.useCallback)(() => {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactNative.Pressable, {
      onPress: () => {
        setCalendarView(calendarView === _enums.CalendarViews.year ? _enums.CalendarViews.day : _enums.CalendarViews.year);
    ...
    }, calendarView === _enums.CalendarViews.year ? `${years.at(0)} - ${years.at(-1)}` : (0, _dayjs.default)(currentDate).format('YYYY'))));
  ...
  const monthSelector = /*#__PURE__*/_react.default.createElement(_reactNative.Pressable, {
    onPress: () => setCalendarView(calendarView === _enums.CalendarViews.month ? _enums.CalendarViews.day : _enums.CalendarViews.month),
    testID: "btn-month",
    accessibilityRole: "button",
  ...
  }, calendarView !== _enums.CalendarViews.year ? monthSelector : null, yearSelector()), mode === 'datetime' && calendarView !== _enums.CalendarViews.year ? /*#__PURE__*/_react.default.createElement(_reactNative.Pressable, {
    onPress: () => setCalendarView(calendarView === _enums.CalendarViews.time ? _enums.CalendarViews.day : _enums.CalendarViews.time),
    accessibilityRole: "button",
    accessibilityLabel: (0, _dayjs.default)(selectedDate).format('HH:mm')
  }, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: [styles.textContainer, theme === null || theme === void 0 ? void 0 : theme.headerTextContainerStyle]
  }, /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    style: [styles.text, theme === null || theme === void 0 ? void 0 : theme.headerTextStyle]
  }, (0, _dayjs.default)(selectedDate).format('HH:mm')))) : null);
