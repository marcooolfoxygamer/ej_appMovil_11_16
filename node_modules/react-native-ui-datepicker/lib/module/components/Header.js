...
const Header = ({
  ...
  const renderPrevButton = /*#__PURE__*/React.createElement(Pressable, {
    ...
    onPress: () => calendarView === CalendarViews.day ? onChangeMonth(-1) : calendarView === CalendarViews.month ? onChangeYear(currentYear - 1) : calendarView === CalendarViews.year && onChangeYear(currentYear - YEAR_PAGE_SIZE),
    testID: "btn-prev",
  ...
  const yearSelector = useCallback(() => {
    ...
    return /*#__PURE__*/React.createElement(Pressable, {
      onPress: () => {
        setCalendarView(calendarView === CalendarViews.year ? CalendarViews.day : CalendarViews.year);
    ...
    }, calendarView === CalendarViews.year ? `${years.at(0)} - ${years.at(-1)}` : dayjs(currentDate).format('YYYY'))));
  ...
  const monthSelector = /*#__PURE__*/React.createElement(Pressable, {
    onPress: () => setCalendarView(calendarView === CalendarViews.month ? CalendarViews.day : CalendarViews.month),
    testID: "btn-month",
    accessibilityRole: "button",
  ...
  const renderSelectors = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(View, {
  ...
  }, calendarView !== CalendarViews.year ? monthSelector : null, yearSelector()), mode === 'datetime' && calendarView !== CalendarViews.year ? /*#__PURE__*/React.createElement(Pressable, {
    ...
    style: [styles.text, theme === null || theme === void 0 ? void 0 : theme.headerTextStyle]
  }, dayjs(selectedDate).format('HH:mm')))) : null);
